...
{
    public:
        BaxandallWDF (float sampleRate)
        {
            Ca.prepare (sampleRate);
            Cb.prepare (sampleRate);
            Cc.prepare (sampleRate);
            Cd.prepare (sampleRate);
            Ce.prepare (sampleRate);
        }
    ...
    private:
        ...
        struct ImpedanceCalc {
            ...
            static void calcImpedance(RType &R) {
                ...
                R.setSMatrixData({{-2 * ((Rb + Rc) * Rd + (Rb + Rc + Rd) * Re + (Rb + Rc + Rd) * Rf) * Ra /
                                   ((Ra * Rb + (Ra + Rb) * Rc) * Rd + (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rb) * Rd) * Re +
                                    (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rc) * Rd + (Rb + Rc + Rd) * Re) * Rf) + 1,
                                                                                                             -2 *
                                                                                                             (Rc * Rd +
                                                                                                              (Rc +
                                                                                                               Rd) *
                                                                                                              ...
                                                                                                              Rf),
                                                                                                                       ...
                                                                                                                       ((Ra *
                                                                                                                        ...
                                                                                                                        (Ra *
                                                                                                                         ...
                                                                                                                         Re) *
                                                                                                                        Rf),
                                          -2 * (Rb * Re - Rc * Rf) * Ra / ((Ra * Rb + (Ra + Rb) * Rc) * Rd +
                                                                           (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rb) * Rd) *
                                                                           Re +
                                                                           (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rc) * Rd +
                                                                            (Rb + Rc + Rd) * Re) * Rf),
                                                                                                                    2 *
                                                                                                                    (Rb *
                                                                                                                     Rd +
                                                                                                                     ...
                                                                                                                     Rf),
                                                                                                                       ...
                                                                                                                       ((Ra *
                                                                                                                        ...
                                                                                                                        (Ra *
                                                                                                                         ...
                                                                                                                         Re) *
                                                                                                                        Rf)},
                                  {-2 * (Rc * Rd + (Rc + Rd) * Re + Rc * Rf) * Rb /
                                   ((Ra * Rb + (Ra + Rb) * Rc) * Rd + (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rb) * Rd) * Re +
                                    (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rc) * Rd + (Rb + Rc + Rd) * Re) * Rf), -2 * ((Ra +
                                                                                                                    Rc) *
                                                                                                                   Rd +
                                                                                                                   (Ra +
                                                                                                                    Rc +
                                                                                                             ...
                                                                                                             1,        -2 *
                                                                                                                       ...
                                                                                                                       ((Ra *
                                                                                                                        ...
                                                                                                                        (Ra *
                                                                                                                         ...
                                                                                                                         Re) *
                                                                                                                        Rf),
                                          2 * (Ra * Re + (Ra + Rc + Re) * Rf) * Rb / ((Ra * Rb + (Ra + Rb) * Rc) * Rd +
                                                                                      (Ra * Rb + (Ra + Rb) * Rc +
                                                                                       (Ra + Rb) * Rd) * Re +
                                                                                      (Ra * Rb + (Ra + Rb) * Rc +
                                                                                       (Ra + Rc) * Rd +
                                                                                                                     ...
                                                                                                                     Rf),
                                                                                                                       ...
                                                                                                                       ((Ra *
                                                                                                                        ...
                                                                                                                        (Ra *
                                                                                                                         ...
                                                                                                                         Re) *
                                                                                                                        Rf)},
                                  {2 * (Rb * Rd + Rb * Re + (Rb + Rd) * Rf) * Rc /
                                   ((Ra * Rb + (Ra + Rb) * Rc) * Rd + (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rb) * Rd) * Re +
                                    (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rc) * Rd + (Rb + Rc + Rd) * Re) * Rf), -2 *
                                                                                                             (Ra * Rd +
                                                                                                              Ra * Re +
                                                                                                              (Ra +
                                                                                                               Re) *
                                                                                                             ...
                                                                                                             ((Ra * Rb +
                                                                                                              ...
                                                                                                              Rf),     -2 *
                                                                                                                       ...
                                                                                                                       ((Ra *
                                                                                                                        ...
                                                                                                                        Rf) +
                                                                                                                       1,
                                          2 * ((Ra + Rb) * Re + (Ra + Re) * Rf) * Rc /
                                          ((Ra * Rb + (Ra + Rb) * Rc) * Rd +
                                           (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rb) * Rd) * Re +
                                           (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rc) * Rd + (Rb + Rc + Rd) * Re) * Rf), -2 *
                                                                                                                    ((Ra +
                                                                                                                      Rb) *
                                                                                                                     Rd +
                                                                                                              ...
                                                                                                              Rf),     2 *
                                                                                                                       ...
                                                                                                                       ((Ra *
                                                                                                                        ...
                                                                                                                        (Ra *
                                                                                                                         ...
                                                                                                                         Re) *
                                                                                                                        Rf),
                                          -2 * (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rb) * Re + (Ra + Rc + Re) * Rf) * Rd /
                                          ((Ra * Rb + (Ra + Rb) * Rc) * Rd +
                                           (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rb) * Rd) * Re +
                                           (Ra * Rb + (Ra + Rb) * Rc + (Ra + Rc) * Rd + (Rb + Rc + Rd) * Re) * Rf) + 1,
                                                                                                                    -2 *
