...
class DC : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst2 = (fConst1 + 4700.0f);
		fConst3 = (1.0f / fConst2);
		float fConst4 = ((9.40000007e-08f * fConst0) + 0.000212765954f);
		fConst5 = (9.74854899e-08f / fConst4);
		fConst6 = (38.6847191f / fConst2);
		fConst7 = (2.64993048e-07f / fConst4);
		float fConst8 = (0.0f - (2.51999999e-09f / fConst4));
		fConst9 = (38.6847191f * fConst8);
		fConst10 = (105.155968f * fConst8);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = float(input0[i]);
			float fTemp0 = (fConst1 * fRec0[1]);
			float fTemp1 = (fTemp0 + (4700.0f * fRec1[1]));
			float fTemp2 = (fConst3 * fTemp1);
			int iTemp3 = ((fTemp2 > 0.0f) - (fTemp2 < 0.0f));
			float fTemp4 = std::exp((fConst6 * (fTemp1 * float(iTemp3))));
			float fTemp5 = (fConst5 * fTemp4);
			float fTemp6 = std::sqrt((2.0f * ((fConst7 * fTemp4) + 1.0f)));
			float fTemp7 = ((fTemp5 < 1.0f) ? ((fTemp6 * ((fTemp6 * ((0.152777776f * fTemp6) + -0.333333343f)) + 1.0f)) + -1.0f) : std::log(std::fabs(fTemp5)));
			...
			float fTemp23 = std::exp((fConst6 * (fTemp1 * float((-1 * iTemp3)))));
			float fTemp24 = (fConst9 * fTemp23);
			float fTemp25 = std::sqrt((2.0f * ((fConst10 * fTemp23) + 1.0f)));
			float fTemp26 = ((fTemp24 < 1.0f) ? ((fTemp25 * ((fTemp25 * ((0.152777776f * fTemp25) + -0.333333343f)) + 1.0f)) + -1.0f) : std::log(std::fabs(fTemp24)));
			float fTemp27 = std::exp(fTemp26);
			float fTemp28 = ((fTemp26 * fTemp27) - fTemp24);
			...
			float fTemp33 = ((fTemp31 * fTemp32) - fTemp24);
			...
			float fTemp38 = ((fTemp36 * fTemp37) - fTemp24);
			float fTemp39 = (fTemp26 + (1.0f - fTemp35));
			float fTemp40 = (fTemp24 + 0.36787945f);
			float fTemp41 = std::sqrt(fTemp40);
			float fTemp42 = ((fConst3 * ((fTemp0 + fTemp1) + (0.0f - (fConst1 * fRec1[1])))) - (0.0258499999f * (float((2 * iTemp3)) * (((fTemp5 < -0.367779434f) ? (((2.33164406f * fTemp22) + (fTemp21 * (((1.93663108f * fTemp22) + -1.81218791f) - (2.35355115f * fTemp21)))) + -1.0f) : (fTemp7 - (fTemp16 + (fTemp19 / ((fTemp18 * fTemp20) - (0.5f * ((fTemp19 * (fTemp7 + (2.0f - fTemp16))) / fTemp20))))))) + ((fTemp24 < -0.367779434f) ? (((2.33164406f * fTemp41) + (fTemp40 * (((1.93663108f * fTemp41) + -1.81218791f) - (2.35355115f * fTemp40)))) + -1.0f) : (fTemp26 - (fTemp35 + (fTemp38 / ((fTemp37 * fTemp39) - (0.5f * ((fTemp38 * (fTemp26 + (2.0f - fTemp35))) / fTemp39)))))))))));
			fVec0[0] = fTemp42;
			fRec1[0] = fTemp42;
